...
<TITLE>P&amp;E Distributors, Inc. - Careers</TITLE>
<meta name="description" content="P&amp;E Distributors is an excellent company to begin or continue your career in the ever-exciting Automotive Industry."></meta>
<meta name="keywords" content="open positions, help wanted, careers, counter person, counterman, salesman, phone sales, order taking, order desk, parts, distributor, wholesale, automotive, accessories "></meta>
    ...
    <TR>
      <TD WIDTH=457 valign="top" ><!-- InstanceBeginEditable name="EditRegion1" -->
        <table width=457 border=0 cellpadding=0 cellspacing=0>
          <!--DWLayoutTable-->
          <tr> 
            <td width="457" valign="top" bgcolor="cccccc"><!--DWLayoutEmptyCell-->&nbsp;</td>
          </tr>
          <tr> 
            <td height=302 valign="top" alt=""><div style="padding-left:10px; padding-right:10px; padding-top:10px; padding-bottom:10px"><h1 class="news_homepagehead">Want to Join the P&amp;E Team?</h1><p align="justify">Have you ever wanted to join or are already a member of the truly exciting Automotive Industry? Are you interested in joining a new group of fellow employees that truly acts like a family? If you are looking for a great atmosphere that rewards effort with excellent benifits then look no further than P&amp;E Distributors.</p><p align="justify">We offer health care benefits, paid vacations and 401(k) opportunities to our established employees.  Feel free to browse our available positions below.  To apply for the positions listed below, please follow the instructions that are located at the bottom of each listing.</p><h3>AVAILABLE POSITIONS:</h3>
<?PHP
$template = "Employment";
$category = 9;
$number = 10;
