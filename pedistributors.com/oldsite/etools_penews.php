...
<TITLE>P&amp;E Distributors, Inc. - P&amp;eNewsletter</TITLE>
<meta name="description" content="Please sign up for our P&eNewsletter to stay up-to-date with what is going on here at P&amp;E Distributors."></meta>
<meta name="keywords" content="news, newsletter, automotive news, distributor, wholesale, automotive, accessories "></meta>
      ...
      <TD WIDTH=457 valign="top" ><!-- InstanceBeginEditable name="EditRegion1" -->
        <table width=457 border=0 cellpadding=0 cellspacing=0>
          ...
          <tr> 
            ...
            <td colspan="2"> <img src="images/newsletter_header02.jpg" width="457" height="190" border="0"></td>
              </tr>
              <tr> 
                ...
                <!--DWLayoutTable-->
                <tr> 
                  <td width=457 valign="top"><div style="padding-right:10px; padding-left:10px; padding-top:10px; padding-bottom:10px;"> 
                      <a href="#" class="style2" onclick="MyWindow=window.open('http://www.pedistributors.com/lists/?p=subscribe&id=8','MyWindow','scrollbars=yes,width=500,height=400');return false;">Click here</a> to sign up for our P&amp;eNewsletter</div></td>
                </tr>
				<tr><td valign="top"><div style="padding-right:10px; padding-left:10px; padding-top:10px; padding-bottom:10px;"><font class="text_bold">P&amp;eNEWS 
                      ARCHIVE:</font><br>
                      <br>
				<?PHP
$template = "penews1";
$category = "10";
$PHP_SELF = "etools_penews2.php";
