...
<TITLE>P&amp;E Distributors, Inc. - Customer News</TITLE>
...
$static = TRUE;
$number = 2;
$template = "NewProd-Main";
$category = "3";
$PHP_SELF = "news.php";
include("cutenews/show_news.php");
?>
                <FONT class="text_bold">MORE CUSTOMER NEWS HEADLINES:</FONT><br>
                <?PHP
$static = TRUE;
$number = 7;
$start_from = 2;
...
include("cutenews/show_news.php");
?><br>
                <a href="customer_news_archive.php" class="style2">Visit the Customer 
                News Archive</a> </div></div></div></div></div></div></td>
          </tr>
        </table>
