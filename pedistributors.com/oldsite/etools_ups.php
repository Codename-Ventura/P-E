...
<TITLE>P&amp;E Distributors, Inc. - UPS Package Tracking</TITLE>
<meta name="description" content="If you have ordered a product fom us and would like to track it using our UPS Package Tracking system, simply enter your P&amp;E Customer Number in the appropriate box and press GO."></meta>
<meta name="keywords" content="UPS, package, tracking, distributor, wholesale, automotive, accessories "></meta>
...
<EMBED SRC="flash/header.swf" WIDTH="457" HEIGHT="118" QUALITY="high"></EMBED>
          ...
          <tr> 
        	...
        	<div style="background:#FFFFFF; margin-left:2em; margin-right:2em; margin-top:2em"><div class="tr"><div class="tl"><div class="br"><div class="bl"> <div style="padding-left:10px; padding-right:10px; padding-top:10px; padding-bottom:10px">
                      ...
                      <p><img src="images/topper_UPS.jpg"> </p>
                      <p>To track your UPS package please use the form below. Nearly 
                        95% of our packages are shipped from our Goodlettsville, 
                        Tennessee location. If your packages happen to be shipped 
                        from one of our alternate locations, please select the alternate 
                        location using the drop-down menu list below. If you are 
                        unsure where your packages are shipped from please ask your 
                        P&amp;E salesman for assistance. </p>
                      <FORM name="tenn2" method="post" action = "http://wwwapps.ups.com/WebTracking/OnlineTool" target="blank">
                        <font class="style6">Your P&amp;E Customer #:</font><br>
                        <input type="text" name="InquiryNumber" value="" size="22" class="style6">
                        <br>
                        <br>
                        <font class="style6">Ship From Date Range:</font><br>
                        ...
                        <br>
                        <font class="style6">Till Today: 
                        <?PHP $today = date("M d, Y"); echo "$today"; ?>
                        <br>
                        <br>
                        Shipped From:<br>
                        </font>
                        <select name="SenderShipperNumber" class="style6">
                        ...
                        <br>
                        <br>
                        <input name="Log In" type="image" value="Track this package" src="images/gobutton.jpg" width="30" height="30" border="0">
