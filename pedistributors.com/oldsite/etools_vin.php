...
<meta name="description" content=" P&amp;E Distributors, Inc - If you have ordered a product fom us and would like to track it using our UPS Package Tracking system, simply enter your P&amp;E Customer Number in the appropriate box and press GO."></meta>
    ...
    <TR>
      <TD WIDTH=457 valign="top" ><!-- InstanceBeginEditable name="EditRegion1" -->
        <table width=457 border=0 cellpadding=0 cellspacing=0>
          <!--DWLayoutTable-->
		  <tr> 
            <td width="457" valign="top" bgcolor="f7f7f7"><!--DWLayoutEmptyCell-->&nbsp;</td>
          </tr>
          <tr> 
                
            <td colspan="2"> <img src="images/topper_UPS.jpg" width="457" height="79" border="0"></td>
              </tr>
              <tr> 
                <td height=109 colspan="2" valign="top" background="images/px.jpg" style="background-position:right; background-repeat:repeat-y " alt=""> 
                  <table width=457 border=0 cellpadding=0 cellspacing=0>
                <!--DWLayoutTable-->
                <tr> 
                  <td width=457 height=326 valign="top"><div style="padding-right:10px; padding-left:10px; padding-top:10px; padding-bottom:10px;"> 
                      If you wish to find out additional information about a vehicle, 
                      such as Engine and Transmission specifications, simply enter 
                      the VIN Number of the vehicle below and press the GO button. 
                      A pop-up window will open with the specific information. 
                      <form name="Form1" method="post" action="http://vin.stronghold.com/Lookup.aspx" id="Form1">


			<table border="0" cellpadding="10" cellspacing="0" width="400">
				<tr bordercolor="#ffffff">
					<td><P><font class="text_bold"> Enter the VIN Number Below:</font></P>
					</td>
				</tr>
			</table>
			            <table border="1" bordercolor="#666666" cellpadding="10" cellspacing="0" width="400">
                          <tr bgcolor="#F7F7F7">
					        <td valign="middle"> 
                              <input name="tboxVIN" type="text" id="tboxVIN" />
                      ...
                      <P><strong>VIN Checker<br>Provided by:</strong><br><a href="http://www.stronghold.com/company.html"><img src="http://vin.stronghold.com/Images/logo_sm.jpg" border="0" style="padding-top5px"></a></P>
                    </div></td>
                </tr>
              </table></td>
              </tr>
