...
<TITLE>P&amp;E Distributors, Inc. - Rebates and Promotions</TITLE>
...
<EMBED SRC="flash/header.swf" WIDTH="457" HEIGHT="118" QUALITY="high"></EMBED>
          ...
          <tr> 
            <td valign="top" alt="">
        	<div style="background:#FFFFFF; margin-left:2em; margin-right:2em; margin-top:2em"><div class="tr"><div class="tl"><div class="br"><div class="bl"> <div style="padding-left:10px; padding-right:10px; padding-top:10px; padding-bottom:10px"><font class="text_bold">REBATES 
                &amp; PROMOTIONS:</font><br>
                <br>
                <?PHP
$static = TRUE;
...
?>
                <FONT class="text_bold">MORE REBATES &amp; PROMOTIONS:</FONT><br>
                <?PHP
$static = TRUE;
$number = 8;
$start_from = 4;
