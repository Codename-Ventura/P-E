...
<div class="title"><p><br /><strong>Online Line Card</strong></p></div>
...
<center>
<br /><p><form name="form1">VIEW:&nbsp;&nbsp;
  <select name="menu1" onChange="loadPage(this.form.elements[0])">
      <option <?php if($type == "all"){ echo "selected";}?> value="<?php echo $_SERVER['PHP_SELF'];?>?p=linecard&line=all">ALL LINES</option>
      <option value="<?php echo $_SERVER['PHP_SELF'];?>?p=linecard&line=truck" <?php if($type == "truck"){ echo "selected";}?>>Truck &amp; Diesel Accessories</option>
      <option value="<?php echo $_SERVER['PHP_SELF'];?>?p=linecard&line=performance" <?php if($type == "performance"){ echo "selected";}?>>Performance Products &amp; Hard Parts</option>
      <option value="<?php echo $_SERVER['PHP_SELF'];?>?p=linecard&line=audio" <?php if($type == "audio"){ echo "selected";}?>>Mobile Audio/Video/Security</option>
    </select>
</form></p><br />
...
<table width="775" border="0" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" style="float:left">
      <?php
...
<font color="#990000" size="3"><a name="<?php echo $v;?>name"></a><strong><?php if($v == "3"){ echo "#";} else{echo $v;}?></strong></font></td>
      ...
      <td align="center" valign="top" nowrap bgcolor="#f7f7f7" style="border-bottom: thin solid #CCCCCC"> 
        <div style="padding:5px"><font color="#000000"><a href="http://www.pedistributors.com/index.php?p=vendors&vendor_detail=<?php echo $k['id'];?>"><?php echo $k['line'];?></a></font></div></td>
      <td valign="top" style="border-bottom: thin solid #CCCCCC"><div style="padding:5px" align="left"><strong><?php echo $k['name'];?></strong><br>
