<?php
if(isset($admin->creditApp)){
?>
<div class="main" id="invoice">
<?php
echo $admin->creditApp;
?>
<span style="float:right; clear:both; margin:1em .5em 0 0"><a href="JavaScript:CallPrint('invoice');">Print this credit app</a></span>
</div>
<?php
}else{
?>
