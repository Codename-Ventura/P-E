...
function pageresponse($type, $extras){ //ADDS A PAGE RESPONSE BOX
	...
	switch($type){
		...
		break;
		case 'no_email';
		$message = '<div class="errorbox">Your email is not on file.<br>Please try again, or call your salesman for assistance</div>';
		break;
		case 'password_sent';
		$message = '<div class="successbox">Your password has been sent to the email on file.<br>Please delete the email after you have noted your password</div>';
		break;
		case 'pw_mismatch';
		$message = '<div class="errorbox">Your passwords did not match.<br>Please try again</div>';
		break;
		case 'form_incomplete';
		$message = '<div class="errorbox">Your form was not complete.<br>Please check your information and try again.</div>';
		break;
		case 'sql_success';
		$message = '<div class="successbox">Your information has been updated.</div>';
		break;
		case 'sql_fail';
		$message = '<div class="errorbox">There was an error updating your information.</div>';
		break;
		case 'eBlast_error';
		$message = '<div class="errorbox">Please enter company name &amp; valid email address, thank you.</div>';
		break;
	}
