...
$image_table .= "<td align=\"center\" onclick=\"location.href='index.php?p=vendors&vendor_detail=".$v[id]."'\" onMouseOver=\"this.style.border='1px #000 dashed'\" onMouseOut=\"this.style.border='1px #FFF dashed'\" style=\"border:1px #FFF solid; text-align:center\" class=\"image_table_cell\"><a href=\"index.php?p=vendors&vendor_detail=".$v[id]."\"><img src=\"".$v[logo]."\" width=\"120px\" style=\"padding:.25em\" align=\"center\" border=\"0\"></a></td>";
$count++;
}
...
$vendor_details[products] = array_slice($vendor_details[products],0,20);
