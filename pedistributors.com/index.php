...
$_SESSION[image_array][8]['src'] = "images/flipads/EARN2.gif";
$_SESSION[image_array][8]['manufacturer'] = "Show Tickets";
$_SESSION[image_array][8]['date'] = date("m-d-Y");


$_SESSION[image_array][9]['src'] = "images/flipads/undercover_banner.gif";
$_SESSION[image_array][9]['manufacturer'] = "Undercover";
...
if(!empty($simple_layout) && $simple_layout == true){
	include('simple_frontend.php');
}else{
