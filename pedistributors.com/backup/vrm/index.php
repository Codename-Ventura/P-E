...
<div id="content">
	...
	<div id="fancymenu">
	<ul>
    <li class="current" id="menu_home"><a class="border_bonus" href="index.php" title="Home">Home</a></li>
	<li id="menu_about"><a href="#" title="About">About</a></li>
	<li id="menu_services"><a href="services.php" title="Services">Services</a></li>
...
<div id="top"><a href="#"><?php echo get_random_image('./images/headers/');?></a></div>
