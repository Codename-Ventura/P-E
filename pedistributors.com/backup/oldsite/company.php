...
<EMBED SRC="flash/header.swf" WIDTH="457" HEIGHT="118" QUALITY="high"></EMBED>
          ...
          <tr> 
            <td valign="top" alt="">
        	<div style="background:#FFFFFF; margin-left:2em; margin-right:2em; margin-top:2em"><div class="tr"><div class="tl"><div class="br"><div class="bl"><div style="padding-left:10px; padding-right:10px; padding-top:10px; padding-bottom:10px"><font class="text_bold">COMPANY NEWS:</font><br><br>
                <?PHP
$static = TRUE;
$number = 2;
...
?>
                <FONT class="text_bold">MORE COMPANY NEWS HEADLINES:</FONT><br>
                <?PHP
$static = TRUE;
$number = 7;
$start_from = 2;
...
include("cutenews/show_news.php");
?><br>
                <a href="company_news_archive.php" class="style2">Visit the Company 
