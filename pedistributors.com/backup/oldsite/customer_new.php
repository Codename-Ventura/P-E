...
<TITLE>P&amp;E Distributors, Inc. - New Customers</TITLE>
<meta name="description" content="To become a new P&amp;E Distributors customer you MUST meet our basic account criteria."></meta>
<meta name="keywords" content="customers, customer, new account, application, distributor, wholesale, automotive, accessories "></meta>
...
<EMBED SRC="flash/header.swf" WIDTH="457" HEIGHT="118" QUALITY="high"></EMBED>
          ...
          <tr> 
            <td valign="top" alt="">
        	<div style="background:#FFFFFF; margin-left:2em; margin-right:2em; margin-top:2em"><div class="tr"><div class="tl"><div class="br"><div class="bl"> <div style="padding-left:10px; padding-right:10px; padding-top:10px; padding-bottom:10px"><font class="text_bold">CUSTOMER NEWS:</font><br><br>

<h1 class="news_homepagehead" style="padding:10px">Reasons Why We Are the Best:</h1>
                <p class="mainpagelist">&#149; We've served our customers since 1962<br>
                &#149; Family-owned and operated for 46 years<br>
                &#149; Over 300 major product lines in stock<br>
                &#149; 4 sales locations and 3 distribution centers<br>
                &#149; Full line traditional warehouse<br>
                &#149; True blue pricing from the factory<br>
                &#149; Online stock and price checking<br>
                &#149; Online ordering<br>
                &#149; Experienced phone sales staff<br>
                &#149; SAME-DAY DELIVERY**<br>
                &#149; Same-day shipping<br>
                &#149; EZ customer return program<br>
                &#149; Regional marketing programs<br>&nbsp;</p>
                
                
                
                <font class="news_homepagehead">New Customer Requirements</font><br><br>
                <strong>To become a P&amp;E Distributors, Inc., customer you must 
                meet EACH of the following criteria listed below. Please read the ENTIRE list.</strong> 
                <br><br>1. You <strong>MUST </strong>be a legitimate, automotive-aftermarket 
                    related business that sells the product types that are available 
                    from P&amp;E Distributors. No P&amp;E Distributors wholesale 
                    accounts are allowed for individuals or non-business licensed 
                    companies.
                  <br>
                  <br>
                  2. You <strong>MUST</strong> purchase products from P&amp;E 
                    Distributors with the intent to resale those products to consumers.
                  <br>
                  <br>
                  3. You <strong>MUST</strong> provide P&amp;E with a copy of 
                    your business license and/or federal tax ID number when you 
                    submit your completed account application.
                  <br><br>
                  4. You <strong>MUST</strong> provide P&amp;E a copy of your 
                    State Tax Certificate of Resale when you submit your completed 
                    account application.
                  <br><br>
                  5. You <strong>MUST</strong> provide P&amp;E a photo of your 
                    store front when you submit your completed account application. 
                    This is required to prove that your business has a <em>real</em> 
                    location. If you are an internet based business, please provide 
                    us with your full URL address when you submit your account 
                    application.<br><br>
					
                  6. You <strong>MUST</strong> read and understand the
                    <a href="termsandconditions.php" class="style2">P&amp;E Terms and Conditions</a>.
					<br><br>
					
					7. You <strong>MAY</strong> be required to place an opening order ($2,500 minimum) in order to open an account with P&amp;E Distributors, Inc.<br><br>
					
                  8. You <strong>MUST</strong> print and <strong>COMPLETELY</strong> 
                    fill out the account application form. Once your application 
                    is complete, please mail or fax (preferred) both sheets back 
                    to us. You can send all completed applications <strong>BY 
                    FAX TO 615-851-4053 ATTN: SALES DEPARTMENT MANAGER</strong> 
                    or by mail to P&amp;E Distributors, Inc., ATTN: Sales Department 
                    Manager, 709 Rivergate Parkway, Goodlettsville, TN 37072.<br><br>

                <center>
                  <img src="images/AccountAppButton.gif" width="325" height="50" border="0" usemap="#Map"> 
                  <map name="Map">
                      
                    <area shape="rect" coords="12,5,209,46" href="pdfs/PE%20APPLICATION.pdf" target="_blank">
                      <area shape="rect" coords="222,8,310,42" href="http://www.adobe.com" target="_blank">
                    </map>
                  <br><br>
</center><br><br>
                  
                <font class="footertext">PLEASE NOTE: Submission of the completed 
                ACCOUNT APPLICATION and compliance with the required account criteria 
                does not guarantee an account activation with P&amp;E Distributors. 
                New Accounts may be required to make an initial buy-in due to 
                location and/or other contributing factors.</font>
