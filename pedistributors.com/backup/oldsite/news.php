...
<meta name="description" content="P&amp;E Distributors News Article - Thanks for reading!"></meta>
<?php
...
<title><?=($_GET['id'] ? ''.show_title($_GET['id']).' - News Category: '.show_cat($_GET['ucat']) : ($_GET['category'] ? show_cat($_GET['category']) : 'P&amp;E Distributors, Inc. - News')); ?></title>
<!-- InstanceEndEditable --> 
<!--sphider_noindex-->
    ...
    <TR>
      <TD WIDTH=457 valign="top" ><!-- InstanceBeginEditable name="EditRegion1" --> 
        <table width=457 border=0 cellpadding=0 cellspacing=0>
          ...
          <tr> 
            <td width="457" valign="top" bgcolor="#000000"> 
              <div style="background:#FFFFFF; margin-left:2em; margin-right:2em; margin-top:1em"><div class="tr"><div class="tl"><div class="br"><div class="bl"><div style="padding-left:10px; padding-right:10px;">
              <div id="newssection">
			<?PHP
