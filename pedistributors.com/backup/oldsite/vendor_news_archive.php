...
<title>P&amp;E Distributors, Inc. - Vendor News Archive</title>
<!-- InstanceEndEditable --> 
<!--sphider_noindex-->
        ...
        <table width=457 border=0 cellpadding=0 cellspacing=0>
          ...
          <tr> 
            <td width="457" valign="top"> 
              <div style="padding-left:10px; padding-right:10px; padding-top:10px; padding-bottom:10px; background:#FFFFFF"><FONT class="text_bold">VENDOR NEWS ARCHIVE:</FONT><br><br>
			<?PHP
