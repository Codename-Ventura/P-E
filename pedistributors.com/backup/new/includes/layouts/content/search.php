...
<tr><td colspan="8" style="text-align:right; font-size:10px"><a href="#" onclick="$('td.hide_price').show();"><img src="images/buttons/show.png" border="0" /></a><a href="#" onclick="$('td.hide_price').hide();"><img src="images/buttons/hide.png" border="0" /></a></td></tr>
...
Available</td><td>Retail</td><td class="hide_price">Jobber</td><td class="hide_price">Tru-Blu<br />
...
<tr>
<td><?php echo $v[2]; ?></td><td><?php echo $v[3]; ?></td><td style="text-align:left"><?php echo $v[6]; ?></td><td><?php echo $v[7]; ?></td><td>$<?php echo $v[8]; ?></td><td class="hide_price">$<?php echo $v[10]; ?></td><td class="hide_price">$<?php echo $v[12]; ?></td><td><input type="text" size="2" name="parts[<?php echo $v[1];?>]" value="0" style="text-align:center"/></td>
