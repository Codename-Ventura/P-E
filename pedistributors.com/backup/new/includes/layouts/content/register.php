...
<div class="row">
	<div class="col" style="color:#E80000">Address:</div>
    <div class="rcol"><input type="text" name="shipping_address" class="req" /></div>
</div>
<div class="row">
	<div class="col" style="color:#E80000">City:</div>
    <div class="rcol"><input type="text" name="shipping_city" class="req" /></div>
</div>
<div class="row">
	<div class="col" style="color:#E80000">State:</div>
...
<div class="row">
	<div class="col" style="color:#E80000">Zip:</div>
    <div class="rcol"><input type="text" name="shipping_zip" class="req"/></div>
</div>
