<span style="padding-left:25px; float:left; font-size:18px">Toll-Free:(800) 251-2034</span>
...
<div id="logged_in_box">
	...
	<span style="margin:0; padding:0; float:right; clear:both;">
		...
		?>
		<a href="index.php?p=account">My Account</a> | <a href="index.php?p=logout">Logout</a>
    </span>
