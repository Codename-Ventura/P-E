...
<span style="width:100%; text-align:center"><div class="titles">Apply for an account below...</div></span>
...
<div class="row">
    ...
    <div class="rcol"><input type="text" name="bus_name" class="req" /></div>
</div>
<div class="row">
	<div class="col" style="color:#E80000">Business Type:</div>
    <div class="rcol"><select name="bus_type">
...
<div class="row">
    ...
    <div class="rcol"><input type="text" name="taxid" class="req" /></div>
</div>
<div class="row">
...
<div class="row">
    ...
    <div class="rcol"><input type="text" name="salesman" class="req" />(salesman's name)</div>
</div>
<div class="row">
	<div class="col" style="color:#E80000">Years in Business:</div>
    <div class="rcol"><input type="text" name="years_in_biz" class="req" /></div>
</div>
<div class="row">
	<div class="col" style="color:#E80000">Buyer's Name:</div>
    <div class="rcol"><input type="text" name="buyer_name" class="req" /></div>
</div>
<div class="row">
	<div class="col" style="color:#E80000">Do you require a purchase order?:</div>
    <div class="rcol"><select name="poreq"><option value="Yes">Yes</option><option value="No">No</option></select></div>
</div>
<div class="left-half-border" style="width:75%">
<strong>Mailing Address</strong>
<div class="row">
	<div class="col" style="color:#E80000">Address:</div>
    <div class="rcol"><input type="text" name="bus_address" class="req" /></div>
</div>
<div class="row">
	<div class="col" style="color:#E80000">City:</div>
    <div class="rcol"><input type="text" name="bus_city" class="req" /></div>
</div>
<div class="row">
	<div class="col" style="color:#E80000">State:</div>
    <div class="rcol"><select name="bus_state">
...
<div class="row">
    ...
    <div class="rcol"><input type="text" name="bus_zip" class="req"/></div>
</div>           
<div class="row">
	<div class="col" style="color:#E80000">Bus. Phone:</div>
    <div class="rcol"><input type="text" name="bus_phone" class="req" /></div>
</div>
<div class="row">
	<div class="col">Fax:</div>
    <div class="rcol"><input type="text" name="bus_fax" /></div>
</div>
<div class="row">
	<div class="col">Email:</div>
    <div class="rcol"><input type="text" name="bus_email" /></div>
</div>
<div class="row">
	<div class="col" style="border:0; text-align:right"><input type="checkbox" name="shipaddy" value="true" onclick="$('#shipaddy').slideToggle();" /></div>
...
<div class="row">
	<div class="col" style="color:#E80000">Address:</div>
    <div class="rcol"><input type="text" name="ship_address" class="req" /></div>
</div>
<div class="row">
	<div class="col" style="color:#E80000">City:</div>
    <div class="rcol"><input type="text" name="ship_city" class="req" /></div>
</div>
<div class="row">
	<div class="col" style="color:#E80000">State:</div>
    <div class="rcol"><select name="ship_state">
		<option value="AL">Alabama</option>
		<option value="AK">Alaska</option>
		<option value="AZ">Arizona</option>
		<option value="AR">Arkansas</option>
...
<div class="row">
	<div class="col" style="color:#E80000">Zip:</div>
    <div class="rcol"><input type="text" name="ship_zip" class="req"/></div>
</div>
	...
	<div class="titles">Financial Information</div>
    	...
    	<div class="left-half-border" style="width:75%">
        	<div class="row">
    			...
    			<div class="rcol"><input type="text" name="prop_value" class="req" /></div>
			</div>
        	<div class="row">
				<div class="col" style="color:#E80000">Mortgage Amount:</div>
    			<div class="rcol"><input type="text" name="mort_amt" class="req" /></div>
			</div>
        	<div class="row">
        	...
        	<div class="row">
    			...
    			<div class="rcol"><input type="text" name="sales_vol" class="req" /></div>
			</div>        
    	...
    	<div class="left-half-border">
        	...
        	<div class="row">
    			...
    			<div class="rcol"><input type="text" name="bank_acct" class="req" /></div>
			</div>        
	...
	<div class="titles">Owner/Partner Information</div>
    	<div class="left-half-border">
        	<div class="row">
    			...
    			<div class="rcol"><input type="text" name="owner_name" class="req" /></div>
			</div>
        	<div class="row">
				<div class="col" style="color:#E80000">Address:</div>
		...
		<option value="WY">Wyoming</option>
			...
			<div class="row">
    			...
    			<div class="rcol"><input type="text" name="owner_ss" class="req"/></div>
			</div>
    	...
    	<div class="left-half-border">
        	...
        	<div class="row">
    			...
    			<div class="rcol"><input type="text" name="partner_name" /></div>
			</div>
        	<div class="row">
		...
		<option value="WY">Wyoming</option>
			...
			<div class="row">
    			...
    			<div class="rcol"><input type="text" name="partner_ss" /></div>
			</div> </div>
        </div> <!-- CLOSE CONTAINER LEFT-HALF-BORDER -->
...
<div class="text-box">
	<div class="titles">Trade Reference #1</div>
    	<div class="left-half-border">
        	<div class="row">
				<div class="col" style="color:#E80000">Name:</div>
    			<div class="rcol"><input type="text" name="ref1_name" class="req" /></div>
			</div>
            <div class="row">
				<div class="col" style="color:#E80000">City:</div>
    			<div class="rcol"><input type="text" name="ref1_city" class="req"/></div>
			</div>     
            <div class="row">
				<div class="col" style="color:#E80000">State:</div>
    			<div class="rcol"><select name="ref1_state">
		<option value="AL">Alabama</option>
		<option value="AK">Alaska</option>
		<option value="AZ">Arizona</option>
		<option value="AR">Arkansas</option>
		...
		<option value="WY">Wyoming</option>
            ...
            <div class="row">
				<div class="col" style="color:#E80000">Zip:</div>
    			<div class="rcol"><input type="text" name="ref1_zip" class="req" /></div>
			</div>   
        </div> <!-- CLOSE CONTAINER LEFT-HALF-BORDER -->
    	...
    	<div class="left-half-border">
        	<div class="row">
				<div class="col" style="color:#E80000">Account #:</div>
    			<div class="rcol"><input type="text" name="ref1_acct" class="req" /></div>
			</div>
        	<div class="row">
				<div class="col" style="color:#E80000">Phone #:</div>
    			<div class="rcol"><input type="text" name="ref1_phone" class="req"/></div>
			</div>
        	<div class="row">
				<div class="col" style="color:#E80000">Fax #:</div>
    			<div class="rcol"><input type="text" name="ref1_fax" class="req" /></div>
			</div>       
        </div> <!-- CLOSE CONTAINER LEFT-HALF-BORDER -->
...
<div class="text-box">
	<div class="titles">Trade Reference #2</div>
    	<div class="left-half-border">
        	        	<div class="row">
				<div class="col" style="color:#E80000">Name:</div>
    			<div class="rcol"><input type="text" name="ref2_name" class="req" /></div>
			</div>
            <div class="row">
				<div class="col" style="color:#E80000">City:</div>
    			<div class="rcol"><input type="text" name="ref2_city" class="req" /></div>
			</div>     
            <div class="row">
				<div class="col" style="color:#E80000">State:</div>
    			<div class="rcol"><select name="ref2_state">
		<option value="AL">Alabama</option>
		<option value="AK">Alaska</option>
		<option value="AZ">Arizona</option>
		<option value="AR">Arkansas</option>
		...
		<option value="WY">Wyoming</option>
            ...
            <div class="row">
				<div class="col" style="color:#E80000">Zip:</div>
    			<div class="rcol"><input type="text" name="ref2_zip" class="req" /></div>
			</div>   
        </div> <!-- CLOSE CONTAINER LEFT-HALF-BORDER -->
    	...
    	<div class="left-half-border">
        	<div class="row">
				<div class="col" style="color:#E80000">Account #:</div>
    			<div class="rcol"><input type="text" name="ref2_acct" class="req"/></div>
			</div>
        	<div class="row">
				<div class="col" style="color:#E80000">Phone #:</div>
    			<div class="rcol"><input type="text" name="ref2_phone" class="req" /></div>
			</div>
        	<div class="row">
				<div class="col" style="color:#E80000">Fax #:</div>
    			<div class="rcol"><input type="text" name="ref2_fax" class="req" /></div>
			</div>  
        </div> <!-- CLOSE CONTAINER LEFT-HALF-BORDER -->
...
<div class="text-box">
	<div class="titles">Trade Reference #3</div>
    	<div class="left-half-border">
        	<div class="row">
				<div class="col" style="color:#E80000">Name:</div>
    			<div class="rcol"><input type="text" name="ref3_name" class="req"/></div>
			</div>
            <div class="row">
				<div class="col" style="color:#E80000">City:</div>
    			<div class="rcol"><input type="text" name="ref3_city" class="req" /></div>
			</div>     
            <div class="row">
				<div class="col" style="color:#E80000">State:</div>
    			<div class="rcol"><select name="ref3_state">
		<option value="AL">Alabama</option>
		<option value="AK">Alaska</option>
		<option value="AZ">Arizona</option>
		<option value="AR">Arkansas</option>
		...
		<option value="WY">Wyoming</option>
            ...
            <div class="row">
				<div class="col" style="color:#E80000">Zip:</div>
    			<div class="rcol"><input type="text" name="ref3_zip" class="req" /></div>
			</div>   
        </div> <!-- CLOSE CONTAINER LEFT-HALF-BORDER -->
    	...
    	<div class="left-half-border">
        	<div class="row">
				<div class="col" style="color:#E80000">Account #:</div>
    			<div class="rcol"><input type="text" name="ref3_acct" class="req" /></div>
			</div>
        	<div class="row">
				<div class="col" style="color:#E80000">Phone #:</div>
    			<div class="rcol"><input type="text" name="ref3_phone" class="req" /></div>
			</div>
        	<div class="row">
				<div class="col" style="color:#E80000">Fax #:</div>
    			<div class="rcol"><input type="text" name="ref3_fax" class="req" /></div>
			</div>       
        </div> <!-- CLOSE CONTAINER LEFT-HALF-BORDER -->
