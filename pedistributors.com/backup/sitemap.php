                  ...
                  <td background="images/px2.jpg" bgcolor="#F7F7F7" style="background-position:top; background-repeat:repeat-x " width=220 alt=""> 
                    <div style="padding-left:7px"> 
                      <table width=206 border=0 cellpadding=0 cellspacing=0>
                        <!--DWLayoutTable-->
                        <form id="listBuilderForm" name="login_form" action="http://store.pedistributors.com/customer/login" method="POST" target="_blank">
                          ...
                          <tr> 
                            <td height=15 colspan="2" valign="top"><div align="center"><a href="http://store.pedistributors.com/customer/reminder"><font size="-2">Forget your password?</font></a><br><br><a href="register.php" class="style2" \>Click Here to Sign Up!</a></div></td>
                          </tr>
                        </form>
                      </table>
                    </div></td>
